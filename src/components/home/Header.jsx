                        ...
                        {navItems.map((item, index) => (
                            ...
                            >
                                <NavLink
                                    ...
                                    className={({isActive}) => isActive ? "text-blue-700 font-semibold relative before:absolute before:bottom-0 before:left-0 before:w-full before:h-[2px] before:bg-blue-500" : "text-gray-700"}
                                >
                                    {item}
                                </NavLink>
                            </li>
